@extends('layouts.app', ['page_title' => 'KUESIONER - MANIPULASI'])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Daftar Kuesioner Manipulasi</h3>
                            </div>
                                    ...
                                    @else
                                        <td>
                                            <span class="badge badge-success">
                                                {{ $survey['presentase']['opsi_1'] * 100/5 }}%
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge badge-info">
                                                {{ $survey['presentase']['opsi_2'] * 100/5 }}%
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge badge-warning">
                                                {{ $survey['presentase']['opsi_3'] * 100/5 }}%
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge badge-danger">
                                                {{ $survey['presentase']['opsi_4'] * 100/5 }}%
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge badge-primary">
                                                {{ $survey['presentase']['opsi_5'] * 100/5 }}%
                                            </span>
                                        </td>
                                    @endif
                                    <td>
