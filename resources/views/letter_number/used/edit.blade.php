                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Ubah Data Penomoran</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/arsip/penomoran/'. $letter_number_used->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="pl-lg-4">
                                @include('letter_number.used._form', ['data' => $letter_number_used])
