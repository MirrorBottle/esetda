...
<head>
    ...
    <title>{{ $title ?? 'Beranda' }} - Biro Humas</title>
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand text-success" href="{{ url('/') }}">
            <img src="{{ asset('images/' . \App\Setting::getValue('logo'))  }}" alt="logo kaltim">
        ...
        <ul class="nav navbar-nav ml-auto mr-3">
            <li class="nav-item dropdown">
                <a class="nav-link nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                    aria-expanded="false">
                    <img class="img-avatar" src="{{ asset('images/avatar.png') }}" alt="user avatar">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.22.2/locale/id.js" integrity="sha256-4nmx6MlwnQuGm3O2dG/Vu2ylDATo8uVfGjY9CxQaYXI=" crossorigin="anonymous"></script>
