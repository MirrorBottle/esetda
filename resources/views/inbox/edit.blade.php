                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Ubah Surat Masuk</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/surat-masuk/'. $inbox->id) }}" enctype="multipart/form-data" data-status="edit" id="form-input">
                            @csrf
                            @method('PUT')
                            @include('inbox._form', ['data' => $inbox])
                        </form>
                    </div>
                </div>
            </div>
