                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Ubah Data Pejabat</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('pejabat/'.$pejabat->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="pl-lg-4">
                                @include('pejabat._form', ['data' => $pejabat])
                                <div>
                                    <button type="submit" class="btn btn-primary mt-4">
                                        <i class="fa fa-reload"></i> Simpan Perubahan
                                    </button>
                                </div>
                            </div>
                        </form>
