                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Ubah Data Pejabat SKPD</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/skpd-pejabat/'. $skpd_employee->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('skpd_id') ? ' has-danger' : '' }}">
                                    ...
                                    <select name="skpd_id" id="input_skpd_id" class="form-control select2 form-control-alternative{{ $errors->has('skpd_id') ? ' is-invalid' : '' }}" required>
                                        ...
                                        @foreach ($skpds as $skpd)
                                            @php $selected_skpd = old('skpd_id', $skpd_employee->skpd_id) == $skpd->id ? 'selected' : ''; @endphp
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="input_name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name', $skpd_employee->name) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('nip') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nip" id="input_nip" class="form-control form-control-alternative{{ $errors->has('nip') ? ' is-invalid' : '' }}" value="{{ old('nip', $skpd_employee->nip) }}">
                                ...
                                <div class="form-group{{ $errors->has('position') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="position" id="input_position" class="form-control form-control-alternative{{ $errors->has('position') ? ' is-invalid' : '' }}" value="{{ old('position', $skpd_employee->position) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('group') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="group" id="input_group" class="form-control form-control-alternative{{ $errors->has('group') ? ' is-invalid' : '' }}" value="{{ old('group', $skpd_employee->group) }}">
