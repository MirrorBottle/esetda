                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Tambah SKPD Baru</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/skpd') }}">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group {{ $errors->has('budget_expanse') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea class="form-control form-control-alternative {{ $errors->has('budget_expanse') ? ' is-invalid' : '' }}" rows="3" name="budget_expanse" id="input_budget_expanse" required>{{ old('budget_expanse') }}</textarea>
                                ...
                                <div class="form-group{{ $errors->has('wa_number') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="wa_number" id="input_wa_number" class="form-control form-control-alternative{{ $errors->has('wa_number') ? ' is-invalid' : '' }}" value="{{ old('wa_number') ?? '62' }}" required>
                                ...
                                <div class="form-group{{ $errors->has('contact') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="contact" id="input_contact" class="form-control form-control-alternative{{ $errors->has('contact') ? ' is-invalid' : '' }}" value="{{ old('contact') }}" required>
